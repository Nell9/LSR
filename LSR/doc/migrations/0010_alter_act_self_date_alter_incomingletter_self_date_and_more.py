...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("doc", "0009_alter_act_self_date_alter_incomingletter_self_date_and_more"),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateTimeField(
                default=datetime.datetime(
                    2025, 7, 9, 7, 44, 13, 177691, tzinfo=datetime.timezone.utc
                ),
        ...
        migrations.AlterField(
            ...
            field=models.DateField(
                default=datetime.datetime(
                    2025, 7, 9, 7, 44, 13, 186691, tzinfo=datetime.timezone.utc
                ),
